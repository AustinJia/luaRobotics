...
function sysCall_init()
    ...
    leftMotor=sim.getObjectHandle("cylinder3_motor1") -- Handle of the left motor
    rightMotor=sim.getObjectHandle("cylinder3_motor2") -- Handle of the right motor
    backMotor=sim.getObjectHandle("cylinder3_motor3") -- Handle of the right motor
    noseSensorFront=sim.getObjectHandle("proximity_sensor3_1") -- Handle of the proximity sensor
    noseSensorBack=sim.getObjectHandle("proximity_sensor3_2") -- Handle of the proximity sensor
